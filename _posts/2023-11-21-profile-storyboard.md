...
Before this, from July 2021 to March 2022, I worked as a Data Scientist at Buy-Quickly and the Alibaba Tmall Division. My primary responsibility was to design a clustering algorithm tailored for a specific segment of online consumers. Additionally, I initiated a data pipeline project at Buy-Quickly.
...
## Episode 1: The first taste of Machine Learning
I entered the realm of machine learning in the summer of 2018, during which I completed a project to predict the customer behavior in shopping malls in one of my Finance classes. Classic Machine Learning techniques for example Linear Regression, SVM and Clustering first came into my sight. I struggled a lot as a college freshman with little knowledge in both Math and Computer Science.
However, with a great amount of effort that I put into the project and the patient instruction from my lecturer, I set on the journey of Machine Learning.
## Episode 2: Transit from Quant to Machine Learning
After 3 years' undergraduate studies, I had been exposed to plenty of advanced Machine Learning technologies as well as its financial usage. I am capable of applying Supervised learning and unsupervised learning to more projects at this time. I have written a Al agent for the Snake game, image detection and classification as well as more precise and practical predictions on marketing performance. However, the more I absorbed machine learning knowledge, the deeper I was fascinated by its subtlety and decided to fully devote myself to becoming a Machine Learning Engineer.
Serve customers with Machine Learning
After graduating from undergraduate school, I joined an E-Commerce company in China as a Data Scientist. During that time, I also served at Alibaba Group as a contractor with similar duty.
With Machine Learning, I devised and implemented an algorithm to score customers in online luxury market and further segmented them into several categories with unique distinguishing features. This is for our clients to better characterize their target audience for personalized advertisement as well as locate themselves in an alien market. This methodology as well a utility toolkit going with it has been published to thousands of online merchants to accelerate their business.
## Episode 3: Large Language Model journey
...
## Future
I see myself as a Machine Learning Engineer as well as Digital transformation promoter. During my experience it witnessed and callete ip brean about what dictal tratormerican is lie ve anda
what we can achieve with the computer.
Digital transformation will be a lengthy and tough journey in any industry. It contains several stages, each of which is a complex system question involving not only technical solutions, but also a comprehensive adjustment of the system as a whole.
